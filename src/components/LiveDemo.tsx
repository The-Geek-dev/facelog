...
import { Camera, CameraOff, UserCheck, Scan, AlertCircle, RefreshCw } from 'lucide-react'
    ...
    const scanInterval = setInterval(() => {
      ...
      if (progress >= 100) {
        ...
        const detected: DetectedStudent = {
          ...randomStudent,
          confidence: 95 + Math.random() * 4.5,
          timestamp: new Date()
        }
        
        setDetectedStudents(prev => {
          // Avoid duplicates
          if (prev.some(s => s.id === detected.id)) {
            return prev
          }
      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-white/70 leading-relaxed max-w-3xl mx-auto">
            Experience FACELOG's facial recognition in action. Allow camera access to see the scanning overlay.
          </p>
        </div>
                  ...
                  <div className="flex items-center gap-2">
                    {isStreaming && (
                      ...
                      >
                        ...
                        {isScanning && scanProgress < 100 ? 'Scanning...' : 'Scan Face'}
                      </Button>
                    )}
                  </div>
                </div>
                ...
                <div className="relative aspect-video bg-slate-900 flex items-center justify-center">
                  ...
                  {!isStreaming && !error && (
                    <div className="text-center p-8">
                      ...
                      <p className="text-white/60 mb-6">Click below to start the camera demo</p>
                      <Button 
                        onClick={startCamera} 
                  ...
                  <AnimatePresence>
                    {detectedStudents.length === 0 ? (
                      <div className="text-center py-12 text-white/40">
                        ...
                        <p className="text-xs mt-1">Start scanning to mark attendance</p>
                      </div>
                    ) : (
                        ...
                        >
                          <div className="flex items-start justify-between">
                            <div>
                              ...
                              <div className="text-sm text-white/50">{student.studentId}</div>
                            </div>
          ...
          <div className="mt-8 text-center">
            <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-6 py-3">
              ...
              <span className="text-sm text-white/70">
                This is a visual demo. Connect to the Flask backend for actual facial recognition.
              </span>
            </div>
          </div>
        </div>
